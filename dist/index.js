...
const calculateSkipChildren = (includeTags, excludeTags, tags, isDescribeNode, envVars) => {
...
const removeTagsFromNode = (node, parentTags, includeTags, excludeTags, isDescribeNode, envVars) => {
